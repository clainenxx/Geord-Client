...
public class GeordSettingsScreen extends Screen {
    ...
    protected void init() {
        ...
        // --- KOLOM KANAN (Sliders Animasi & Render + Toggle Shield) ---
        ...
        // Tambah Toggle Disabled Shield Tint (Biar posisi simetris sejajar dengan Smart Hitbox)
        this.addDrawableChild(ButtonWidget.builder(
        ...
        // --- BARIS BAWAH (Slider Tinggi Tangan Kiri & Kanan) ---
