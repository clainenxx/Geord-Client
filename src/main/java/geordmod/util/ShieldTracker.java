...
public class ShieldTracker {
    ...
    // Track kapan kita terakhir attack musuh yang blocking, buat validasi sound
    ...
    // Dipanggil dari ShieldAttackMixin saat kita attack musuh
    ...
    // Dipanggil dari ShieldEntityEventMixin saat status 30
    ...
    public static boolean isShieldDisabled(PlayerEntity player) {
        ...
        // Player lokal: pakai cooldown bawaan vanilla
